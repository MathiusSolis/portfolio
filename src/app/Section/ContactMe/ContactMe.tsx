...
export const ContactMe = () => {
    return (
        <section className="flex flex-col gap-5 min-h-screen">
            ...
            <div className="flex-1 relative flex flex-wrap justify-center items-center py-10 mt-10 gap-16">
                <MainBg />
                <div className="my-10 relative max-[1315px]:absolute max-[1315px]:top-0 max-[1315px]:left-0 max-[1315px]:bottom-0 max-[1315px]:right-0 max-[1315px]:m-auto max-[1315px]:w-full max-[1315px]:h-[68%]" >
                    ...
                    <PlanetIcon className="bg-[#2D577A] left-[70%] max-[1315px]:left-[83%] bottom-[-15%] w-16 h-16" />
                    <PlanetIcon className="delay05 bg-[#512B67] top-[-20%] left-[-10%] max-[1315px]:left-[5%] w-24 h-24" />
                    <PlanetIcon className="delay1 bg-[#978526] top-[23%] left-[65%] max-[1315px]:left-[90%] w-16 h-16" />
